...
* Unzips the files from above link
* Creates results folder if it does not exist (all files are stored in this folder)
* Loads features.txt from the unzipped files
* Loads X_train.txt, y_train.txt, subject_train.txt
* Activity labels from y_train
* Ids from subject_train
* Appends test dataset X_test.txt, y_test.txt, subject_test.txt
...
* contains 10299 rows and 82 columns 
